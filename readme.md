...
<p align="justify">Название данного репозитория говорит само за себя. Это я изучаю <i><b>Python</b></i>. Сюда я публикую каждый код, написанный мной в качестве решения самостоятельной работы после изучения каждой темы.
Стоит добавить, что помимо тех задач, которые я выношу в качестве примера, существуют еще различные задачи, выполненние при помощи модуля <b><i>Turtle</i></b>.</p>  
...
```
Однажды ковбой Джо нанялся в помощники шерифу. Шериф выдал ковбою Джо строку и попросил собрать из её букв как можно больше слов sheriff. Каждая буква может использоваться не более одного раза. Ковбой Джо тут же приступил к заданию шерифа, но к сожалению, он не умеет читать. Помогите ковбою Джо. 
