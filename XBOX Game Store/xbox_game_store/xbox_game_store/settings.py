"""
Django settings for xbox_game_store project.
...
SECRET_KEY = 'django-insecure-#%9(5#@9d##3ihvju-q%%v&@v5+%a$kpgrr4^c5v1ygx--d46m'
...
WSGI_APPLICATION = 'xbox_game_store.wsgi.application'
