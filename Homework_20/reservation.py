...
# задача
# Необходимо разработать класс для управления ресурсами в рамках проекта. Класс Ресурс должен содержать информацию о типе ресурса, доступном количестве и его использовании в проекте. Методы должны предоставлять функционал по добавлению, выделению и отслеживанию использования ресурсов.
